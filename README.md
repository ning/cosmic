...
This plugin allows Cosmic scripts to send email. It uses the [Mail gem](https://github.com/mikel/mail):
...
Nagios currently doesn't provide a simple way to interact with it remotely. To help with this, Ning has a project called [Nagix](https://github.com/ning/nagix) that provides a REST server and CLI for Nagios. Tools can then interact with the REST server remotely to access status information or issue commands against a Nagios instance.
